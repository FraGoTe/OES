...
if(a.suffix==null){a.suffix="%";}if(a.decimals==null){a.decimals=2;}return this.format(a);}});(function(){var c={a:/[àáâãäåaa]/g,A:/[ÀÁÂÃÄÅAA]/g,c:/[ccç]/g,C:/[CCÇ]/g,d:/[dd]/g,D:/[DÐ]/g,e:/[èéêëee]/g,E:/[ÈÉÊËEE]/g,g:/[g]/g,G:/[G]/g,i:/[ìíîï]/g,I:/[ÌÍÎÏ]/g,l:/[lll]/g,L:/[LLL]/g,n:/[ñnn]/g,N:/[ÑNN]/g,o:/[òóôõöøo]/g,O:/[ÒÓÔÕÖØ]/g,r:/[rr]/g,R:/[RR]/g,s:/[ššs]/g,S:/[ŠSS]/g,t:/[tt]/g,T:/[TT]/g,ue:/[ü]/g,UE:/[Ü]/g,u:/[ùúûuµ]/g,U:/[ÙÚÛU]/g,y:/[ÿý]/g,Y:/[ŸÝ]/g,z:/[žzz]/g,Z:/[ŽZZ]/g,th:/[þ]/g,TH:/[Þ]/g,dh:/[ð]/g,DH:/[Ð]/g,ss:/[ß]/g,oe:/[œ]/g,OE:/[Œ]/g,ae:/[æ]/g,AE:/[Æ]/g},b={" ":/[\xa0\u2002\u2003\u2009]/g,"*":/[\xb7]/g,"'":/[\u2018\u2019]/g,'"':/[\u201c\u201d]/g,"...":/[\u2026]/g,"-":/[\u2013]/g,"&raquo;":/[\uFFFD]/g};
...
(function(){var a=function(e,d,c,b){if(e==1){return d;}else{if(e==2||e==3||e==4){return c;}else{return b;}}};Locale.define("cs-CZ","Date",{months:["Leden","Únor","Brezen","Duben","Kveten","Cerven","Cervenec","Srpen","Zárí","Ríjen","Listopad","Prosinec"],months_abbr:["ledna","února","brezna","dubna","kvetna","cervna","cervence","srpna","zárí","ríjna","listopadu","prosince"],days:["Nedele","Pondelí","Úterý","Streda","Ctvrtek","Pátek","Sobota"],days_abbr:["ne","po","út","st","ct","pá","so"],dateOrder:["date","month","year"],shortDate:"%d.%m.%Y",shortTime:"%H:%M",AM:"dop.",PM:"odp.",firstDayOfWeek:1,ordinal:".",lessThanMinuteAgo:"pred chvílí",minuteAgo:"približne pred minutou",minutesAgo:function(b){return"pred {delta} "+a(b,"minutou","minutami","minutami");
},hourAgo:"približne pred hodinou",hoursAgo:function(b){return"pred {delta} "+a(b,"hodinou","hodinami","hodinami");},dayAgo:"pred dnem",daysAgo:function(b){return"pred {delta} "+a(b,"dnem","dny","dny");
},weekAgo:"pred týdnem",weeksAgo:function(b){return"pred {delta} "+a(b,"týdnem","týdny","týdny");},monthAgo:"pred mesícem",monthsAgo:function(b){return"pred {delta} "+a(b,"mesícem","mesíci","mesíci");
},yearAgo:"pred rokem",yearsAgo:function(b){return"pred {delta} "+a(b,"rokem","lety","lety");},lessThanMinuteUntil:"za chvíli",minuteUntil:"približne za minutu",minutesUntil:function(b){return"za {delta} "+a(b,"minutu","minuty","minut");
},hourUntil:"približne za hodinu",hoursUntil:function(b){return"za {delta} "+a(b,"hodinu","hodiny","hodin");},dayUntil:"za den",daysUntil:function(b){return"za {delta} "+a(b,"den","dny","dnu");
},weekUntil:"za týden",weeksUntil:function(b){return"za {delta} "+a(b,"týden","týdny","týdnu");},monthUntil:"za mesíc",monthsUntil:function(b){return"za {delta} "+a(b,"mesíc","mesíce","mesícu");
},yearUntil:"za rok",yearsUntil:function(b){return"za {delta} "+a(b,"rok","roky","let");}});})();Locale.define("cs-CZ","FormValidator",{required:"Tato položka je povinná.",minLength:"Zadejte prosím alespon {minLength} znaku (napsáno {length} znaku).",maxLength:"Zadejte prosím méne než {maxLength} znaku (nápsáno {length} znaku).",integer:"Zadejte prosím celé císlo. Desetinná císla (napr. 1.25) nejsou povolena.",numeric:'Zadejte jen císelné hodnoty (tj. "1" nebo "1.1" nebo "-1" nebo "-1.1").',digits:"Zadejte prosím pouze císla a interpunkcní znaménka(napríklad telefonní císlo s pomlckami nebo teckami je povoleno).",alpha:"Zadejte prosím pouze písmena (a-z). Mezery nebo jiné znaky nejsou povoleny.",alphanum:"Zadejte prosím pouze písmena (a-z) nebo císlice (0-9). Mezery nebo jiné znaky nejsou povoleny.",dateSuchAs:"Zadejte prosím platné datum jako {date}",dateInFormatMDY:'Zadejte prosím platné datum jako MM / DD / RRRR (tj. "12/31/1999")',email:'Zadejte prosím platnou e-mailovou adresu. Napríklad "fred@domain.com".',url:"Zadejte prosím platnou URL adresu jako http://www.example.com.",currencyDollar:"Zadejte prosím platnou cástku. Napríklad $100.00.",oneRequired:"Zadejte prosím alespon jednu hodnotu pro tyto položky.",errorPrefix:"Chyba: ",warningPrefix:"Upozornení: ",noSpace:"V této položce nejsou povoleny mezery",reqChkByNode:"Nejsou vybrány žádné položky.",requiredChk:"Tato položka je vyžadována.",reqChkByName:"Prosím vyberte {label}.",match:"Tato položka se musí shodovat s položkou {matchName}",startDate:"datum zahájení",endDate:"datum ukoncení",currendDate:"aktuální datum",afterDate:"Datum by melo být stejné nebo vetší než {label}.",beforeDate:"Datum by melo být stejné nebo menší než {label}.",startMonth:"Vyberte pocátecní mesíc.",sameMonth:"Tyto dva datumy musí být ve stejném mesíci - zmente jeden z nich.",creditcard:"Zadané císlo kreditní karty je neplatné. Prosím opravte ho. Bylo zadáno {length} císel."});
